...
export default function Header() {
  ...
  return (
    <header className="bg-background border-b border-neutral-200 sticky top-0 z-10">
      <div className="flex items-center justify-between px-4 md:px-6 py-3">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="bg-gray-300 hover:bg-gray-400 w-7 h-7 rounded-full">
            <button
              onClick={toggleTheme}
          ...
          <div className="relative" ref={notificationRef}>
            {/* <div className="bg-[#6ee3fa] w-7 h-7 rounded-full"> */}
