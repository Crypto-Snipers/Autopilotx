        ...
        <div className="p-4 flex items-center justify-between bg-blue-100">
          <div className="flex items-center space-x-2">
            <img
              ...
              className="h-6 w-6"
            />
            <span className="text-base font-semibold text-blue-900">CoinDCX</span>
          </div>
          <div className="flex items-center gap-1">
            <span className="text-xs font-semibold text-blue-900">How to add CoinDCX?</span>
            <a
              href=""
              target="_blank"
              rel="noopener noreferrer"
            ...
            <div className='flex gap-1'>
              ...
              <div>
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  https://coindcx.com/manageapikeys
                </a>
              </div>
            </div>
