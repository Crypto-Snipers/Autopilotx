      ...
      try {
        ...
        if (typeof Balances === 'object' && Balances.balance !== undefined) {
          ...
          if (!isNaN(balanceValue)) {
            ...
            sessionStorage.setItem("currency", Balances.currency ? Balances.currency.toUpperCase() : "USD");
          }
        } else {
      ...
      <div className="flex-1 md:ml-[14rem]">
        ...
        <main className="p-2 md:p-4">
          <div className="flex justify-between w-full min-h-0">
                        ...
                        <div className="text-right">
                          ...
                          <div className="flex items-center">
                            {isManuallyRefreshing ? (
                              ...
                              <span
                                className={`text-2xl p-1 font-bold ${balance > 0 ? 'text-green-600' : balance < 0 ? 'text-red-600' : 'text-blue-600'}`}
                              >
                                {isLoadingBalance
                                  ? 'Loading…'
                                  : `${String(Balances?.currency ?? 'USD').toUpperCase() === 'USD' ? '$' : '₹'}${balance.toLocaleString('en-US', {
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {isLoadingDeactivate ? (
                                  ...
                                  <Switch
                                    ...
                                    // onCheckedChange={async (checked) => {
                                    //   if (!checked) return; // Only proceed when toggling ON
                                    ...
                                    //     // Auto return to off position after 1 second
                                    //     setTimeout(() => {
                                    //       setRunAllEnabled(false);
                                    //     }, 1000);
            ...
            <div className="basis-[35%] h-screen sticky top-0">
              <DeployedStrategies />
            </div>
